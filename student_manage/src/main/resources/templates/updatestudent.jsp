...
<body>
	...
	<div class="container">
		...
		<div class="main_contents">
			<div id="sub_content">
				<form th:action="@{/update}" method="post" th:object="${studList}">
					...
					<div class="row mb-4">
						...
						<label for="studentID" class="col-md-2 col-form-label">Student
							ID</label>
						<div class="col-md-4">
							<input  th:field="*{student_id}" type="text" class="form-control" name="student_id"  id="studentID">
						</div>
					</div>
					<div class="row mb-4">
						<div class="col-md-2"></div>
					...
					<div class="row mb-4">
						...
						<div class="col-md-4">
							<input type="date"  name="dob" th:field="*{dob}" class="form-control" id="dob">
						</div>
					</div>
					...
					<div class="row mb-4">
						...
						<div class="col-md-4">
							<select  th:field="*{education}" class="form-select" name="education"
                ...
                <div class="col-md-4">
                    ...
                    <a ><button type="button" class="btn btn-danger" data-bs-toggle="modal-body" data-bs-target="#exampleModal">
